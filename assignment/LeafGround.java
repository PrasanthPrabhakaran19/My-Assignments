...
public class LeafGround {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//div[@class='grid formgrid']//input)[1]")).sendKeys("Prasanth"); 
		...
		findEmail.sendKeys("pkprasanth56@gmail.com");
		findEmail.sendKeys(Keys.TAB);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[@class='grid formgrid']//textarea")).sendKeys("Prasanth from Salem");
		...
		driver.findElement(By.xpath("//li[@class='ui-autocomplete-input-token']/input")).sendKeys("Prasanth");
		Thread.sleep(1000);
