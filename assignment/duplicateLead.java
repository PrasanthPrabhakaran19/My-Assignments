...
public class duplicateLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Prasasnth");
		...
		createcompanyname.sendKeys("Avanze");
		//driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Avanze");
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Prasanth P");
		driver.findElement(By.className("smallSubmit")).click();
